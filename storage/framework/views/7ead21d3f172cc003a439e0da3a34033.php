<?php $__env->startSection('title', trans_field($story, 'title')); ?>
<?php $__env->startSection('og_image', $story->first_image ? asset('storage/'.$story->first_image) : ''); ?>
...
<section class="hero-detailed" <?php if($story->first_image): ?> style="background-image:url('<?php echo e(asset('storage/'.$story->first_image)); ?>')" <?php endif; ?>>
    <div class="hero-detailed__overlay"></div>
    <div class="hero-detailed__inner">
        <span class="hero-detailed__tag"><i class="fas fa-book-open"></i> <?php echo e(__('common.nav_stories')); ?></span>
        <h1 class="hero-detailed__title"><?php echo e(trans_field($story, 'title')); ?></h1>
        <p class="hero-detailed__desc">
            <?php echo e(trans_field($story, 'person_name')); ?><?php echo e(trans_field($story, 'age') ? ', '.trans_field($story, 'age').' '.__('common.age') : ''); ?><?php echo e(trans_field($story, 'location') ? ' | '.trans_field($story, 'location') : ''); ?>

        </p>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($story->goal_amount > 0): ?>
        <div class="hero-detailed__stats">
            <div class="hero-detailed__stat"><span class="hero-detailed__stat-value">$<?php echo e(number_format($story->raised_amount ?? 0)); ?></span><span class="hero-detailed__stat-label"><?php echo e(__('site.raised')); ?></span></div>
            <div class="hero-detailed__stat"><span class="hero-detailed__stat-value">$<?php echo e(number_format($story->goal_amount)); ?></span><span class="hero-detailed__stat-label"><?php echo e(__('site.goal')); ?></span></div>
            <div class="hero-detailed__stat"><span class="hero-detailed__stat-value"><?php echo e($story->progressPercent()); ?>%</span><span class="hero-detailed__stat-label"><?php echo e(__('common.progress')); ?></span></div>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.progress-bar','data' => ['raised' => $story->raised_amount ?? 0,'goal' => $story->goal_amount]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['raised' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($story->raised_amount ?? 0),'goal' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($story->goal_amount)]); ?>
        ...
        <div class="donation-layout">
            ...
            <div class="gallery-container">
                ...
                <div class="project-detail-card">
                    <h2 class="project-detail-card__title"><?php echo e(trans_field($story, 'title')); ?></h2>

                    <div class="project-detail-card__meta">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trans_field($story, 'person_name')): ?>
                        <div class="project-detail-card__meta-row">
                            <i class="fas fa-user"></i>
                            <span><?php echo e(trans_field($story, 'person_name')); ?><?php echo e(trans_field($story, 'age') ? ', '.trans_field($story, 'age').' '.__('common.age') : ''); ?></span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trans_field($story, 'location')): ?>
                        <div class="project-detail-card__meta-row">
                            <i class="fas fa-map-marker-alt"></i>
                            <span><?php echo e(trans_field($story, 'location')); ?></span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>

                    <div class="project-detail-card__desc">
                        <?php echo trans_field($story, 'content'); ?>

                    </div>

                    <?php $shareUrl = urlencode(url()->current()); $shareText = urlencode(trans_field($story, 'title')); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($donations->isNotEmpty()): ?>
<section class="section section--muted">
    <div class="container">
        <h2 class="section-title section-title--center"><?php echo e(__('donor_wall.recent_donations')); ?></h2>
        <div class="donor-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $donations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<section class="section">
    <div class="container">
        <h2 class="section-title section-title--center"><?php echo e(__('common.similar_stories') ?? 'قصص مشابهة'); ?></h2>
        <div class="similar-grid">
            ...
            <a href="<?php echo e(route('stories.show', ['locale' => $currentLocale, 'id' => $s->id])); ?>" class="similar-card">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\etelaf-relief-laravel\resources\views/stories/show.blade.php ENDPATH**/ ?>